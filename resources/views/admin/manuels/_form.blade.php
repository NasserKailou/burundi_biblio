...
<div class="space-y-6">
    ...
    <div>
        ...
        <textarea id="description" name="description" rows="3"
            class="mt-1 block w-full rounded-md border border-bns-border px-3 py-2 text-sm shadow-sm">{{ old('description', $manuel->description ?? '') }}</textarea>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="file" id="fichier" name="fichier" accept=".pdf,.epub" class="mt-1 block w-full text-sm file:mr-3 file:rounded-md file:border-0 file:bg-bns-muted file:px-3 file:py-1.5 file:text-sm">
        ...
        <div>
            ...
            <input type="file" id="couverture" name="couverture" accept="image/*" class="mt-1 block w-full text-sm file:mr-3 file:rounded-md file:border-0 file:bg-bns-muted file:px-3 file:py-1.5 file:text-sm">
